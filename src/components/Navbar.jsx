...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="sticky top-0 z-50 bg-white w-full shadow-md flex justify-between py-4  sm:pl-16 xl:pl-20 xl:pr-24 ">
        <div className="flex items-center">
          <img src={Logo} alt="Logo" className="h-10 mr-4 md:pl-2" />
                  ...
                  { /*  For large device  */  }
        <div>
          <ul className="hidden md:flex  items-center py-2 gap-5">
            <li className="text-[#082D4A] font-semibold">
              <a href="#">Home</a>
            </li>
            <li className="text-[#082D4A] font-semibold">
              <a href="#">About us</a>
